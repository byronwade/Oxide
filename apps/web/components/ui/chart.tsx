...
function ChartTooltipContent({
	...
	return (
		<div className={cn("border-gray-200/50 dark:border-gray-800/50 bg-background grid min-w-[8rem] items-start gap-1.5 rounded-lg border px-2.5 py-1.5 text-xs shadow-xl", className)}>
