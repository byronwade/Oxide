...
export function Store({ searchQuery, onGameSelect }: StoreProps) {
  ...
  const featuredGames = [
    {
      ...
      discount: null,
      description:
        "An epic RPG adventure with unprecedented freedom and depth. Gather your party and return to the Forgotten Realms...",
      screenshots: [
  ...
  const browseCategories = [
    { name: "Action", icon: Swords, image: "/placeholder.svg?height=200&width=400" },
    { name: "RPG", icon: ScrollText, image: "/placeholder.svg?height=200&width=400" },
    { name: "Strategy", icon: BrainCircuit, image: "/placeholder.svg?height=200&width=400" },
    { name: "Indie", icon: Palette, image: "/placeholder.svg?height=200&width=400" },
    { name: "Adventure", icon: Compass, image: "/placeholder.svg?height=200&width=400" },
    { name: "Simulation", icon: Gamepad2, image: "/placeholder.svg?height=200&width=400" },
    { name: "Sports & Racing", icon: Flame, image: "/placeholder.svg?height=200&width=400" },
    { name: "Puzzle", icon: Puzzle, image: "/placeholder.svg?height=200&width=400" },
  ]
  const curatorRecommendation = {
    ...
    quote:
      "An absolutely stellar roguelike that sets a new standard for the genre. The art, music, and gameplay are all top-notch.",
  }
